...
#CALDB=/Users/ethan/phd/pipeline/files/caldb; export CALDB
...
if [ -z "$CALDBCONFIG" ]; then
    CALDBCONFIG=$CALDB/caldb.config; export CALDBCONFIG
fi  

if [ -z "$CALDBALIAS" ]; then
    CALDBALIAS=$CALDB/alias_config.fits; export CALDBALIAS
fi  
